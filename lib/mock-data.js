...
export const mockPendingTasks = {
  ...
  VESSEL_MANAGER: [
    {
      id: "TASK-VM-001",
      title: "3 Decisions Needed",
      description: "Hull cleaning decision for MV Ocean Star, drydocking schedule for MV Pacific Voyager, and CII compliance actions",
      priority: "HIGH",
      dueDate: addDays(now, 1).toISOString(),
      status: "PENDING",
      count: 3,
    ...
    {
      id: "TASK-VM-002",
      title: "1 Vessel Requires Attention",
      description: "MV Ocean Star: Hull cleaning overdue (142 days), over-consuming fuel (+14%)",
      priority: "URGENT",
      dueDate: addHours(now, 24).toISOString(),
      status: "PENDING",
      count: 1,
      url: "/vessel-manager",
      type: "VESSEL_ATTENTION",
    },
    {
      id: "TASK-VM-003",
      title: "Maintenance Schedule Review",
      description: "Review and approve maintenance schedule for next quarter (3 hull cleanings, 1 drydock)",
      priority: "MEDIUM",
...
// Vessel Manager specific data
export const getVesselManagerData = (imo) => {
  const vessel = mockVessels.find((v) => v.imo === imo)
  if (!vessel) return null

  // Mock enhanced data for vessel manager view
  const vesselManagerData = {
    "9876547": {
      // MV Ocean Star
      performanceScore: 68,
      status: "ATTENTION_NEEDED",
      statusReason: "Hull fouling affecting efficiency",
      currentVoyage: {
        from: "Singapore",
        to: "Rotterdam",
        day: 15,
        totalDays: 35,
        eta: addHours(now, 15 * 24).toISOString(),
        onTime: true,
        nextOperation: "Bunkering @ Port Klang (18 hours)",
      },
      rob: {
        vlsfo: 395,
        lsmgo: 82,
      ...
      metrics: {
        consumptionEfficiency: {
          ...
          plan: 22,
          variance: 14,
          rootCause: "Hull fouling (last cleaned 142 days ago)",
          costImpact: 1935,
          totalWasted: 58000,
        },
        hullPerformance: {
          score: 45,
          daysSinceCleaning: 142,
          daysOverdue: 22,
          resistanceIncrease: 18,
          action: "Hull cleaning recommended immediately",
        },
        enginePerformance: {
          score: 97,
          efficiency: "Normal",
        ...
        charterPartyCompliance: {
          score: 95,
          speed: "WITHIN_TOLERANCE",
          consumption: "MARGINAL",
          consumptionVariance: 1,
          risk: "May face CP claim if not corrected",
        },
      },
      commercialImpact: {
        voyagePnL: -67725,
        bunkerCost: { actual: 548000, budget: 497000, variance: 10.4 },
        savingsPotential: 107000,
      },
      compliance: {
        euEts: "TRACKED",
        fuelEu: "NON_COMPLIANT",
        fuelEuVariance: 1.4,
        cii: "C",
        ciiPercentToD: 68,
      },
      trend: {
        ...
        consumption: [22, 22, 23, 23, 24, 25],
        lastCleaning: "Sep",
        insight: "Clear degradation pattern. Hull cleaning every 120 days keeps consumption optimal. Last cleaning was 142 days ago - 22 days overdue.",
      },
      sisterVesselComparison: [
        { vessel: "MV Atlantic", consumption: 21.5, cleanedDaysAgo: 45 },
        { vessel: "MV Baltic", consumption: 22.1, cleanedDaysAgo: 60 },
        { vessel: "MV Caribbean", consumption: 22.8, cleanedDaysAgo: 90 },
        { vessel: "MV Aegean", consumption: 23.2, cleanedDaysAgo: 105 },
        { vessel: "MV Coral", consumption: 23.8, cleanedDaysAgo: 118 },
        { vessel: "MV Ocean Star", consumption: 25.0, cleanedDaysAgo: 142 },
      ],
      rootCauseAnalysis: [
        {
          factor: "Hull Fouling",
          contribution: 40,
          fuelImpact: 1.2,
          details: "Last cleaned 142 days ago (22 days overdue)",
          action: "Clean immediately (ROI: 589%)",
          actualConsumption: 25,
          expectedConsumption: 22,
        },
        {
          factor: "Weather Impact",
          contribution: 30,
          fuelImpact: 0.9,
          details: "Heavy seas past 3 days (Beaufort 6)",
          action: "Forecast improving to Beaufort 4 (6 hours)",
        },
        {
          factor: "Speed Variance",
          contribution: 20,
          fuelImpact: 0.6,
          details: "Actual 13.6 knots vs Plan 13.5 knots",
          action: "Making up time from earlier delay",
        },
        {
          factor: "Engine Performance",
          contribution: 10,
          fuelImpact: 0.3,
      ...
      currentStatus: {
        position: { lat: 3.2, lon: 101.1 },
        distanceToNextPort: 285,
        nextPort: "Port Klang",
        speed: 13.6,
        heading: 285,
        voyage: {
      ...
      flag: "Liberia",
      class: "DNV",
      master: "Capt. John Smith",
      chiefEngineer: "Eng. Michael Johnson",
    },
    "9876543": {
      // MV Atlantic Star
      performanceScore: 94,
      status: "EXCELLENT",
      statusReason: "Best in class!",
      currentVoyage: {
        from: "Los Angeles",
        to: "Shanghai",
        day: 8,
        totalDays: 28,
        eta: addHours(now, 20 * 24).toISOString(),
        onTime: true,
        nextOperation: "Port call Shanghai",
      },
      rob: {
        vlsfo: 580,
        lsmgo: 120,
      ...
      metrics: {
        consumptionEfficiency: {
          ...
          plan: 22.5,
          variance: -4.4,
          rootCause: "Recent hull cleaning (45 days ago)",
          costImpact: -645,
          totalWasted: -18000,
        },
        hullPerformance: {
        ...
        charterPartyCompliance: {
          score: 100,
          speed: "BETTER_THAN_CP",
          consumption: "BETTER_THAN_CP",
          consumptionVariance: -2,
          risk: null,
        },
      },
      commercialImpact: {
        voyagePnL: 24300,
        bunkerCost: { actual: 387000, budget: 405000, variance: -4.4 },
        savingsPotential: 0,
      },
      compliance: {
        euEts: "EXCELLENT",
      ...
      bestPractices: [
        "Hull cleaning every 120 days (strict schedule)",
        "Master highly experienced with fuel optimization",
        "Excellent weather routing decisions",
        "Can be used as training example for other vessels",
      ],
      trend: {
        months: ["Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
        consumption: [22.5, 22.3, 22.0, 21.8, 21.6, 21.5],
        lastCleaning: "Oct",
        insight: "Consistent excellent performance. Hull cleaning schedule maintained perfectly.",
      },
      currentStatus: {
        position: { lat: 34.0522, lon: -118.2437 },
        distanceToNextPort: 1200,
        nextPort: "Shanghai",
        speed: 14.5,
        heading: 270,
        voyage: {
      ...
      flag: "Liberia",
      class: "DNV",
      master: "Capt. Robert Lee",
      chiefEngineer: "Eng. David Chen",
    },
  }

  return vesselManagerData[imo] || {
    performanceScore: 75,
    status: "HEALTHY",
    ...
    metrics: {
      consumptionEfficiency: {
        score: 75,
        actual: vessel.estimatedConsumption?.VLSFO || 40,
        plan: vessel.estimatedConsumption?.VLSFO || 40,
        variance: 0,
      ...
      charterPartyCompliance: {
        score: 98,
        speed: "WITHIN_TOLERANCE",
        consumption: "WITHIN_TOLERANCE",
        consumptionVariance: 0,
        risk: null,
      },
    },
    commercialImpact: {
      voyagePnL: 0,
      bunkerCost: { actual: 0, budget: 0, variance: 0 },
      savingsPotential: 0,
    },
    compliance: {
      euEts: "TRACKED",
    ...
    currentVoyage: vessel.cargoId
      ...
      : null,
    rob: vessel.currentROB
      ? {
          vlsfo: vessel.currentROB.VLSFO,
          lsmgo: vessel.currentROB.LSMGO,
          daysRemaining: vessel.currentROB.VLSFO / (vessel.estimatedConsumption?.VLSFO || 40),
        }
      : null,
    currentStatus: {
      position: vessel.currentPosition || { lat: 0, lon: 0 },
      distanceToNextPort: 0,
