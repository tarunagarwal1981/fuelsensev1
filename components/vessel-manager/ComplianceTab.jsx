  ...
  return (
    <Card className="max-w-2xl mx-auto">
      <CardHeader className="text-center">
        ...
        <CardTitle className="text-2xl">Compliance Tab - Coming Soon</CardTitle>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-600">
            <li className="flex items-start gap-2">
              ...
              <span>Detailed compliance tracking (EU ETS, FuelEU, CII, MRV)</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-orange-600 mt-1">•</span>
            ...
            <li className="flex items-start gap-2">
              <span className="text-orange-600 mt-1">•</span>
              <span>CII improvement plans and projections</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-orange-600 mt-1">•</span>
              <span>MRV reporting status and validation</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-orange-600 mt-1">•</span>
              <span>Survey schedules and compliance calendar</span>
            </li>
          </ul>
        </div>
      </CardContent>
